...
contested: false
contradictions: 
tags: ["concept", "coverage-gap"]
sources: 
---

# Biophysical Profile

Biophysical Profile is included as a coverage-gap page so existing wiki links resolve and the semantic graph can represent the concept explicitly.
