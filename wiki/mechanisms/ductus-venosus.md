...
contested: false
contradictions: 
tags: ["mechanism", "coverage-gap"]
sources: 
---

# Ductus Venosus

Ductus Venosus is included as a coverage-gap page so existing wiki links resolve and the semantic graph can represent the concept explicitly.
