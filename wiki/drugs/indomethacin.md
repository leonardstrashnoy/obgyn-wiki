...
contested: false
contradictions: 
tags: ["drug", "coverage-gap"]
sources: 
---

# Indomethacin

Indomethacin is included as a coverage-gap page so existing wiki links resolve and the semantic graph can represent the concept explicitly.
