...
contested: false
contradictions: 
tags: ["procedure", "coverage-gap"]
sources: 
---

# Chorionic Villus Sampling

Chorionic Villus Sampling is included as a coverage-gap page so existing wiki links resolve and the semantic graph can represent the concept explicitly.
